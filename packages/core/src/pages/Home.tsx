        ...
        <div class="auth-card">
          ...
          <div style="margin-top: 25px; padding-top: 25px; border-top: 1px solid #e2e8f0; text-align: center;">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener"
              style="display: inline-flex; align-items: center; gap: 6px; padding: 8px 16px; background: #24292e; color: white; border-radius: 6px; text-decoration: none; font-size: 13px; font-weight: 600; transition: all 0.2s;"
              onmouseover="this.style.background='#1a1e22'; this.style.transform='translateY(-1px)'"
